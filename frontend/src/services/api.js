...
axiosInstance.interceptors.response.use(
  ...
  (error) => {
    ...
    if (error.response) {
      ...
      // Check if it's a network error (CORS, offline,)
...
export const productsAPI = {
  ...
  updateStock: (id, data) =>
    axiosInstance.patch(`/admin/products/${id}/stock`, data),
  exportCSV: (params) =>
    axiosInstance.get("/admin/products/export", {
      params,
      responseType: "blob",
    }),
};
...
export const authAPI = {
  ...
  // Clean changePassword single endpoint
  changePassword: (data) => axiosInstance.put("/auth/change-password", data),

  // Delete account endpoint
  deleteAccount: (data) => axiosInstance.delete("/auth/profile", { data }),
};
...
export const userAPI = {
  ...
  setDefaultAddress: (id) =>
    axiosInstance.patch(`/users/addresses/${id}/default`),
  getWishlist: () => axiosInstance.get("/users/wishlist"),
  addToWishlist: (productId) =>
    axiosInstance.post("/users/wishlist", { productId }),
  removeFromWishlist: (productId) =>
    axiosInstance.delete(`/users/wishlist/${productId}`),
...
export const ordersAPI = {
  ...
  getMyOrders: (params) => axiosInstance.get("/orders/myorders", { params }),
  ...
  trackOrder: (trackingNumber) =>
    axiosInstance.get(`/orders/track/${trackingNumber}`),
  returnOrder: (id, data) => axiosInstance.post(`/orders/${id}/return`, data),

  // Admin routes
  getAll: (params) => axiosInstance.get("/admin/orders", { params }),
  updateStatus: (id, status) =>
    axiosInstance.put(`/admin/orders/${id}/status`, { orderStatus: status }),
  delete: (id) => axiosInstance.delete(`/admin/orders/${id}`),
  getStats: () => axiosInstance.get("/admin/orders/stats"),
  getRecent: (limit) =>
    axiosInstance.get("/admin/orders/recent", { params: { limit } }),
  bulkUpdateStatus: (data) =>
    axiosInstance.patch("/admin/orders/bulk-update", data),
  exportCSV: (params) =>
    axiosInstance.get("/admin/orders/export", {
      params,
      responseType: "blob",
    }),
  updatePaymentStatus: (id, isPaid) =>
    axiosInstance.put(`/admin/orders/${id}/payment`, { isPaid }),
  addTracking: (id, trackingNumber) =>
    axiosInstance.post(`/admin/orders/${id}/tracking`, { trackingNumber }),
  getByCustomer: (customerId, params) =>
    axiosInstance.get(`/admin/orders/customer/${customerId}`, { params }),
};
...
export const adminAPI = {
  ...
  getRevenueStats: (params) =>
    axiosInstance.get("/admin/revenue-stats", { params }),
  ...
  getUserActivity: (id, limit) =>
    axiosInstance.get(`/admin/users/${id}/activity`, { params: { limit } }),
  updateUser: (id, data) => axiosInstance.put(`/admin/users/${id}`, data),
  deleteUser: (id) => axiosInstance.delete(`/admin/users/${id}`),
  toggleBlockUser: (id, reason) =>
    axiosInstance.patch(`/admin/users/${id}/toggle-block`, { reason }),
  bulkDeleteUsers: (data) =>
    axiosInstance.post("/admin/users/bulk-delete", data),
  exportUsers: (params) =>
...
export const revenueAPI = {
  getSummary: () => axiosInstance.get("/admin/revenue/summary"),
  getDaily: (days = 7) =>
    axiosInstance.get("/admin/revenue/daily", { params: { days } }),
  getMonthly: (months = 12) =>
    axiosInstance.get("/admin/revenue/monthly", { params: { months } }),
  getQuarterly: () => axiosInstance.get("/admin/revenue/quarterly"),
  getYearly: () => axiosInstance.get("/admin/revenue/yearly"),
  getByRange: (startDate, endDate) =>
    axiosInstance.get("/admin/revenue/range", {
      params: { startDate, endDate },
    }),
  getByProduct: (params) =>
    axiosInstance.get("/admin/revenue/products", { params }),
  getByCategory: () => axiosInstance.get("/admin/revenue/categories"),
  getByCustomer: (params) =>
    axiosInstance.get("/admin/revenue/customers", { params }),
  getForecast: (months = 3) =>
    axiosInstance.get("/admin/revenue/forecast", { params: { months } }),
  getRealtime: () => axiosInstance.get("/admin/revenue/realtime"),
  getByPaymentMethod: () => axiosInstance.get("/admin/revenue/payment-methods"),
  exportReport: (params) =>
    axiosInstance.get("/admin/revenue/export", {
      params,
      responseType: "blob",
    }),
};
...
export const reviewsAPI = {
  ...
  markHelpful: (reviewId) => axiosInstance.post(`/reviews/${reviewId}/helpful`),
...
export const couponsAPI = {
  ...
  exportCSV: () =>
    axiosInstance.get("/admin/coupons/export", { responseType: "blob" }),
};
...
export const notificationsAPI = {
  ...
  // Admin routes
  sendToAll: (data) =>
    axiosInstance.post("/admin/notifications/send-all", data),
  sendToUser: (userId, data) =>
    axiosInstance.post(`/admin/notifications/user/${userId}`, data),
};

// PAYMENTS API
export const paymentsAPI = {
  createPaymentIntent: (data) =>
    axiosInstance.post("/payments/create-intent", data),
  ...
  setDefaultMethod: (id) =>
    axiosInstance.patch(`/payments/methods/${id}/default`),
  getTransactions: (params) =>
    axiosInstance.get("/payments/transactions", { params }),
  getTransactionDetails: (id) =>
    axiosInstance.get(`/payments/transactions/${id}`),
  refund: (id, data) =>
    axiosInstance.post(`/payments/transactions/${id}/refund`, data),
};
...
export const shippingAPI = {
  ...
  trackShipment: (trackingNumber) =>
    axiosInstance.get(`/shipping/track/${trackingNumber}`),
  validateAddress: (address) =>
    axiosInstance.post("/shipping/validate-address", address),

  // Admin routes
  getRates: () => axiosInstance.get("/admin/shipping/rates"),
  updateRate: (id, data) =>
    axiosInstance.put(`/admin/shipping/rates/${id}`, data),
...
export const wishlistAPI = {
  ...
  moveToCart: (productId) =>
    axiosInstance.post("/wishlist/move-to-cart", { productId }),
