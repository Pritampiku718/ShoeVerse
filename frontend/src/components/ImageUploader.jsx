...
import { FaCloudUploadAlt, FaTrash, FaImage, FaCheckCircle } from 'react-icons/fa';
  ...
  const handleFileSelect = async (e) => {
    ...
    try {
      ...
      if (data && data.files) {
        ...
        toast.success(`${data.files.length} image(s) uploaded successfully`, { id: 'upload' });
      }
  ...
  const handleRemoveImage = async (index) => {
    ...
    if (imageToRemove.filename) {
      try {
        ...
        await axiosInstance.delete(`/upload/${imageToRemove.filename}`);
